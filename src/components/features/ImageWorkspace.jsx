...
const ImageWorkspace = ({ isPanelOpen, togglePanel }) => {
    ...
    }, [croppedAreaPixels, selectedImage, setOriginalImage, setIsCropping]);
        ...
        <div className="flex-1 h-full relative flex items-center justify-center bg-background overflow-hidden p-8">
            ...
            {!selectedImage ? (
                <label className="text-center space-y-4 cursor-pointer group relative z-10">
                    ...
                    <p className="text-text-secondary">Click here to upload an image and start editing.</p>
                </label>
            ) : (
                                ...
                                {({ zoomIn, zoomOut, resetTransform }) => (
                                    <>
                                        <TransformComponent wrapperClass="!w-full !h-full" contentClass="!w-full !h-full flex items-center justify-center">
                                            {processedImage ? (
                                                <div className="w-full h-full flex items-center justify-center" onMouseDown={(e) => e.stopPropagation()}>
                                                    <BeforeAfterSlider
